...
import { GATEWAY, SYSTEM_PROMPT, getGatewayUrl, getApiKey } from './config.js';
import {
...
export async function sendMessage(opts, callbacks) {
  ...
  const apiMessages = buildApiMessages(history, imageRetention);
