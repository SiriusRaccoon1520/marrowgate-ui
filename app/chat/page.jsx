...
function Bubble({ msg, theme, bubbleStyle, isStreaming, isMobile, showAvatar, showNickname }) {
  ...
  return (
    <div style={{ marginBottom: 2 }} data-ts={msg.ts}>
      <div style={{
...
function SettingsMenu({ model, setModel, themeId, setThemeId, bubbleStyle, setBubbleStyle, themes, bgImage, setBgImage, showAvatar, setShowAvatar, showNickname, setShowNickname, scrollToTop, scrollToBottom }) {
...
export default function MarrowgateChatV3() {
  ...
  const send = useCallback(async () => {
    ...
    try {
      ...
      const speed = completionTokens
        ...
        : null;
      const finalMeta = { promptTokens, completionTokens, speed, elapsed };
  ...
  }, [input, messages, model, streaming, pendingImages]);
